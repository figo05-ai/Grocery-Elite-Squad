...
class RegisterRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'phone' => [
                ...
                EgyptianPhoneRule::internationalPrefixRule(),
                'min:11',
                'max:13',
                EgyptianPhoneRule::mobileRule(),
    ...
    public function messages(): array
    {
        ...
        return [
            ...
            'phone.not_regex' => EgyptianPhoneRule::foreignPrefixMessage(),
            'phone.regex' => EgyptianPhoneRule::invalidMessage(),
            'phone.min' => EgyptianPhoneRule::lengthMessage(),
            'phone.max' => EgyptianPhoneRule::lengthMessage(),
